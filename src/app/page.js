...
export default function Home() {
 ...
 Immersive LED wristband with millions of colors and dynamic
 ...
 <div className="mt-3 text-sm text-white/80">
 Infrared moving head and transmitter beam out the IR wave
 to control the wristband
 </div>
 </div>
 </div>
 </div>
 ...
 <div>
 <div className="w-fit rounded-full bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-widest text-white">
 Grand MA
 </div>
 <div className="mt-3 text-sm text-white/80">
 ...
 <div className="relative w-full bg-gradient-to-b from-transparent to-white/5 pt-16 pb-24">
