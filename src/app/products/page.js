    ...
    <main className="grid-bg mx-auto max-w-6xl px-6 py-12">
      ...
      <section className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
          <div className="font-inter text-white text-[20px]">Wristbands</div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
          <div className="font-inter text-white text-[20px]">User Tracking</div>
          <div className="mt-2 text-white/70">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
          <div className="font-inter text-white text-[20px]">Stick</div>
          <div className="mt-2 text-white/70">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
          <div className="font-inter text-white text-[20px]">Venue Style 1</div>
          <div className="mt-2 text-white/70">
            Dynamic light patterns and color choreography that amplify emotions.
          </div>
          <div className="mt-4 h-24 rounded-md bg-gradient-to-tr from-[#23A6D5] via-[#23CC34] to-[#FFE144]" />
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
          <div className="font-inter text-white text-[20px]">Venue Style 2</div>
          <div className="mt-2 text-white/70">
            Dynamic light patterns and color choreography that amplify emotions.
          </div>
          <div className="mt-4 h-24 rounded-md bg-gradient-to-tr from-[#23A6D5] via-[#23CC34] to-[#FFE144]" />
